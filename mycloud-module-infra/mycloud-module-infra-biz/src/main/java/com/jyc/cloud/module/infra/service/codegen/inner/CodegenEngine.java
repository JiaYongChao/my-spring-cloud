package com.jyc.cloud.module.infra.service.codegen.inner;
...
import com.jyc.cloud.framework.common.exception.util.ServiceExceptionUtil;
...
import com.jyc.cloud.framework.common.util.date.DateUtils;
import com.jyc.cloud.framework.common.util.date.LocalDateTimeUtils;
import com.jyc.cloud.framework.common.util.object.BeanUtils;
import com.jyc.cloud.framework.common.util.object.ObjectUtils;
import com.jyc.cloud.framework.common.util.string.StrUtils;
import com.jyc.cloud.framework.excel.core.annotations.DictFormat;
import com.jyc.cloud.framework.excel.core.convert.DictConvert;
...
import com.jyc.cloud.framework.operatelog.core.enums.OperateTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "mycloud-module-${table.moduleName}/" + // 顶级模块
                "mycloud-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "mycloud-module-${table.moduleName}/" + // 顶级模块
                "mycloud-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "mycloud-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "mycloud-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
