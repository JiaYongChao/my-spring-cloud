package com.jyc.cloud.module.system.convert.user;

import com.jyc.cloud.framework.common.util.collection.CollectionUtils;
import com.jyc.cloud.framework.common.util.collection.MapUtils;
import com.jyc.cloud.framework.common.util.object.BeanUtils;
import com.jyc.cloud.module.system.controller.admin.dept.vo.dept.DeptSimpleRespVO;
import com.jyc.cloud.module.system.controller.admin.dept.vo.post.PostSimpleRespVO;
import com.jyc.cloud.module.system.controller.admin.permission.vo.role.RoleSimpleRespVO;
import com.jyc.cloud.module.system.controller.admin.user.vo.profile.UserProfileRespVO;
import com.jyc.cloud.module.system.controller.admin.user.vo.user.UserRespVO;
import com.jyc.cloud.module.system.controller.admin.user.vo.user.UserSimpleRespVO;
