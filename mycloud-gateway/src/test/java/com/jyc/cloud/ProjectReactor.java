...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.jyc.cloud";
    private static final String ARTIFACT_ID = "mycloud";
    private static final String PACKAGE_NAME = "com.jyc.cloud";
    private static final String TITLE = "springcloud管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.jyc.cloud";
        String artifactIdNew = "mycloud";
        String packageNameNew = "com.jyc.cloud";
        String titleNew = "springcloud管理系统";
        String projectBaseDirNew = "/Users/jiayongchao/person-work/my-spring-cloud"; // 一键改名后，“新”项目所在的目录
