package com.jyc.cloud.module.infra.service.logger;
...
import com.jyc.cloud.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.jyc.cloud.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.jyc.cloud.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.jyc.cloud.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.jyc.cloud.framework.common.util.date.LocalDateTimeUtils.*;
...
import static com.jyc.cloud.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.jyc.cloud.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("mycloud-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("mycloud-test");
