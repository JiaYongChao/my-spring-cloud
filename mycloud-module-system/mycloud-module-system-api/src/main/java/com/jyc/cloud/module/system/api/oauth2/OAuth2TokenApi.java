package com.jyc.cloud.module.system.api.oauth2;
...
import com.jyc.cloud.module.system.api.oauth2.dto.OAuth2AccessTokenCreateReqDTO;
import com.jyc.cloud.module.system.api.oauth2.dto.OAuth2AccessTokenRespDTO;
...
public interface OAuth2TokenApi {
    ...
    @Parameters({
        ...
        @Parameter(name = "clientId", description = "客户端编号", required = true, example = "mycloudyuanma")
    })
