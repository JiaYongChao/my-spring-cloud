package com.jyc.cloud.module.system.controller.admin.logger.vo.operatelog;
...
import com.jyc.cloud.module.system.enums.DictTypeConstants;
...
public class OperateLogRespVO {
    ...
    @Schema(description = "操作明细", example = "修改编号为 1 的用户信息，将性别从男改成女，将姓名从项目改成源码。")
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "com.jyc.cloud.adminserver.UserController.save(...)")
