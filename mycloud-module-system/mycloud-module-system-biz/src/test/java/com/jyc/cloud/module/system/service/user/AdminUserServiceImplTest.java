package com.jyc.cloud.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.jyc.cloud.framework.common.enums.CommonStatusEnum;
import com.jyc.cloud.framework.common.exception.ServiceException;
import com.jyc.cloud.framework.common.pojo.PageResult;
import com.jyc.cloud.framework.common.util.collection.ArrayUtils;
import com.jyc.cloud.framework.common.util.collection.CollectionUtils;
import com.jyc.cloud.framework.test.core.ut.BaseDbUnitTest;
import com.jyc.cloud.module.infra.api.file.FileApi;
...
import com.jyc.cloud.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.jyc.cloud.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.jyc.cloud.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.jyc.cloud.module.system.controller.admin.user.vo.user.UserSaveReqVO;
...
import com.jyc.cloud.module.system.dal.dataobject.dept.UserPostDO;
import com.jyc.cloud.module.system.dal.dataobject.tenant.TenantDO;
import com.jyc.cloud.module.system.dal.dataobject.user.AdminUserDO;
import com.jyc.cloud.module.system.dal.mysql.dept.UserPostMapper;
import com.jyc.cloud.module.system.dal.mysql.user.AdminUserMapper;
import com.jyc.cloud.module.system.enums.common.SexEnum;
...
import static com.jyc.cloud.framework.common.util.collection.SetUtils.asSet;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("mycloudyuanma");
        ...
        assertEquals("mycloudyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("mycloudyuanma"))).thenReturn("java");
