package com.jyc.cloud.module.infra.controller.admin.codegen;
...
import com.jyc.cloud.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.jyc.cloud.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.jyc.cloud.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.jyc.cloud.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.jyc.cloud.module.infra.convert.codegen.CodegenConvert;
...
import com.jyc.cloud.module.infra.service.codegen.CodegenService;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "mycloud"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "项目")
    })
