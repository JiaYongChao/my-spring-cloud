package com.jyc.cloud.framework.swagger.config;
...
import static com.jyc.cloud.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
public class MycloudSwaggerAutoConfiguration {
