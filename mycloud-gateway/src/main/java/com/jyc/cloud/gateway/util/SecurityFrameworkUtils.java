package com.jyc.cloud.gateway.util;

import cn.hutool.core.map.MapUtil;
import com.jyc.cloud.framework.common.util.json.JsonUtils;
import com.jyc.cloud.gateway.filter.security.LoginUser;
 ...
 * 安全服务工具类
 *
 * copy from mycloud-spring-boot-starter-security 的 SecurityFrameworkUtils 类
 *
 * @author JiaYongChao
 */
